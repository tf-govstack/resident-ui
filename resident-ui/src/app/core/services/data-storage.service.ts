...
export class DataStorageService {
  ...
  getLocationHierarchyLevel(langCode: string){
    return this.httpClient.get(this.BASE_URL  + this.version + '/proxy/masterdata/locationHierarchyLevels/'+langCode);
  }
  ...
  generateOTP(request: any) {
    return this.httpClient.post(this.BASE_URL  + this.version + '/req/otp', request);
  }
