  ...
  constructor(
    ...
    .subscribe((event: NavigationStart) => {
      if (event.navigationTrigger === 'popstate') {
        console.log(window.location.hash.includes("uinservices"))
        if(window.location.hash.includes("uinservices")){
          console.log("Testing2")
          }else{ 
            if(confirm("Are you sure want to leave the page. you will be logged out automatically if you press OK?") === true){
