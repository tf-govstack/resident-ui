...
export const CONFIG_KEYS = {
  ...
  mosip_webui_auto_logout_idle: 'mosip.webui.auto.logout.idle',
  mosip_webui_auto_logout_timeout: 'mosip.webui.auto.logout.timeout',
  mosip_webui_auto_logout_ping: 'mosip.webui.auto.logout.ping',
